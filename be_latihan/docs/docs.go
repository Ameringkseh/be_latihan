...
const docTemplate = `{
            ...
            "get": {
                ...
                "responses": {
                    ...
                    "401": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/model.SwaggerResponse401"
                        }
                    },
                    "500": {
            ...
            "post": {
                ...
                "responses": {
                    ...
                    "403": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/model.SwaggerResponse403"
                        }
                    },
                    "500": {
                        "description": "Internal Server Error",
            ...
            "delete": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/model.SwaggerResponse200"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
    ...
    "definitions": {
        ...
        "model.SwaggerResponse200": {
            "type": "object",
            "properties": {
                "message": {
                    "type": "string",
                    "example": "berhasil memproses permintaan"
                }
            }
        },
        "model.SwaggerResponse401": {
            "type": "object",
            "properties": {
                "message": {
                    "type": "string",
